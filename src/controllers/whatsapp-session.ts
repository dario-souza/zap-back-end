 ...
 */
export const getOrCreateUserSession = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await prisma.whatsAppSession.update({
      ...
      data: {
        ...
        phoneNumber: wahaSession.me?.id?.replace('@c.us', '').replace('@lid', '') || null,
 ...
 */
export const startUserSession = async (req: Request, res: Response): Promise<void> => {
  try {
    const userId = req.user?.id;
 ...
 */
export const getUserQRCode = async (req: Request, res: Response): Promise<void> => {
  try {
    const userId = req.user?.id;
 ...
 */
export const getUserConnectionStatus = async (req: Request, res: Response): Promise<void> => {
  try {
    const userId = req.user?.id;
 ...
 */
export const listAllSessions = async (req: Request, res: Response): Promise<void> => {
  try {
